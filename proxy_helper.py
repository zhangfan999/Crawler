...
class Proxy_helper():
    ...
    def collectUrl(self,ip_que):
        print("代理IP采集线程开启")
        while True:
            # 判断代理IP池里的IP数量是否少于300，如果少于300，开始采集，否则进入休眠
            apiUrl="http://www.66ip.cn/mo.php?sxb=&tqsl=300&port=&export=&ktip=&sxa=&submit=%CC%E1++%C8%A1&textarea=http%3A%2F%2Fwww.66ip.cn%2F%3Fsxb%3D%26tqsl%3D300%26ports%255B%255D2%3D%26ktip%3D%26sxa%3D%26radio%3Dradio%26submit%3D%25CC%25E1%2B%2B%25C8%25A1"
            if ip_que.qsize() < 300:
                print("开始采集代理IP")
